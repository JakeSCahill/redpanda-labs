...
```
// (step {"action":"runShell", "command": "sh ../../setup-tests/tools/rpk-produce.sh", "args": ["'{\"message\": \"success\", \"timestamp\": 1707743943,\"iss_position\": {\"latitude\": \"-28.5723\", \"longitude\": \"-149.4612\"}}'"]})
